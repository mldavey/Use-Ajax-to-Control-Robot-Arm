...
$x = 512;			//arm x coordinate, offset value, so 512 is '0'
$y = 100;			//arm y coordinate, native value
$z = 150;			//arm z coordinate, native value
$wristAngle = 45;	//arm wrist angle . offset value so 90 is '0' or straight wrist
$wristRotate = 0;	//wrist rotation value ,NA for snapper
$gripper = 0;		//gripper control, 0 = close, 512 = open
$delta = 16;		//speed control, smaller value = faster speed
...
echo "Arm should be moving by the time that this is loaded";
