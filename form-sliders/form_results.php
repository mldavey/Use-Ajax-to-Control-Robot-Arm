...
if($changed === 'X-Axis') {
	$changed_value = $changed_value - 512; //get the interpreted value based on the offsets
}

if($changed === 'Wrist Angle') {
	$changed_value = $changed_value - 45; //get hte interpreted value based on the offsets
}
